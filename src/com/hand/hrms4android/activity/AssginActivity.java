...
public class AssginActivity extends ActionBarActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		deliverTo.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				// TODO 自动生成的方法存根
				if(true){
					Intent intent = new Intent(AssginActivity.this, AssEmployeeListActivity.class);
					intent.putExtra(TodoList.ID, getIntent().getStringExtra(TodoList.ID));
...
//			Toast.makeText(DeliverActivity.this, "now", Toast.LENGTH_SHORT).show();
		...
		public void afterTextChanged(Editable s) {
			AssginActivity.super.invalidateOptionsMenu();
