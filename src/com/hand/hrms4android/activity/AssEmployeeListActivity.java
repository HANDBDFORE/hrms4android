...
//public class AssEmployeeListActivity {
...
import com.hand.hrms4android.model.AssginModel;
...
public class AssEmployeeListActivity extends ActionBarActivity implements SearchView.OnQueryTextListener {
...
//    private ArrayAdapter<String> nameList;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        lv.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> parent, View view,
				...
				AssEmployeeListActivity.this.setResult(RESULT_OK, infoIntent);
				AssEmployeeListActivity.this.finish();
			}
        	
		}); 
        sourceSystemName = getIntent().getStringExtra("sourceSystemName");
        CurrenID =getIntent().getStringExtra(TodoList.ID);
        model.load(LoadType.Network, new String[]{sourceSystemName,"",CurrenID});
    }
	...
	public boolean onQueryTextSubmit(String query) {
		...
		if(!query.toString().isEmpty())
			model.load(LoadType.Network, new String[]{sourceSystemName,query.toString(),CurrenID});
