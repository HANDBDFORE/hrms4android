...
import com.hand.hrms4android.util.MD5;
...
public class CacheImageManager {
	...
	private static final String path = Environment.getExternalStorageDirectory() + "/zy_image_cache/";
	 ...
	 *            是否需要以文件形式保存
	 */
	public void updateDrawableCache(String url, Bitmap bitmap, boolean saveToFile) {
		imageCache.put(url, new SoftReference<Bitmap>(bitmap));

		// 只有在存储卡为挂载状态的时候，才尝试像存储卡写入
		if ((saveToFile) && (Environment.getExternalStorageState().equals(Environment.MEDIA_MOUNTED))) {
