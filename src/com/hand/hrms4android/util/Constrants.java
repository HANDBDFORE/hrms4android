...
public class Constrants {
	public static final String APPROVE_RECORD_STATUS_NORMAL = "normal";
	public static final String APPROVE_RECORD_STATUS_WAITING = "waiting";
	public static final String APPROVE_RECORD_STATUS_DIFFERENT = "different";
	public static final String APPROVE_RECORD_STATUS_ERROR = "error";

	public static final String SYS_PREFRENCES_TOKEN = "token";
	...
	public static final String SYS_PREFRENCES_PASSWORD = "password";
